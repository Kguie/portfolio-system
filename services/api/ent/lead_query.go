...
func (lq *LeadQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (lq *LeadQuery) FirstIDX(ctx context.Context) string {
...
func (lq *LeadQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (lq *LeadQuery) OnlyIDX(ctx context.Context) string {
...
func (lq *LeadQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (lq *LeadQuery) IDsX(ctx context.Context) []string {
	ids, err := lq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (lq *LeadQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(lead.Table, lead.Columns, sqlgraph.NewFieldSpec(lead.FieldID, field.TypeString))
	_spec.From = lq.sql
